            ...
            <div class="grid md:grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 p-10">
                ...
                <x-content.card>
                    ...
                    <div class="px-6 py-4">
                        ...
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 line-clamp-3">{!! $post->content !!}
                        </p>
                        <a href="{{route('recipe.show', $post->id)}}"
                            class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300" style="background-color: #C5C171">
                            Read more
